...
<template>
  <USlideover v-model="show" side="right">
    <div class="flex flex-col h-full">
      ...
      <div class="py-2 px-4 flex gap-1.5 border-b">
        ...
        <UButton color="green" icon="i-ic-add" variant="ghost"/>
        <UButton v-if="props.showHome" color="orange" icon="i-ic-home" variant="ghost" @click="clickFolder($state.os_infos?.home_dir)"/>
      </div>
